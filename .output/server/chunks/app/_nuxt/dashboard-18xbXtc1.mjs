import { _ as _sfc_main$4 } from './DefaultPage-LzR7S962.mjs';
import { _ as __nuxt_component_1$1 } from './Container-fiqteY-J.mjs';
import { u as useInjectButtonGroup, _ as __nuxt_component_2$1, b as __nuxt_component_0, g as getULinkProps } from './Button-kAcpi0J0.mjs';
import { _ as __nuxt_component_1 } from './Avatar-tswZooNR.mjs';
import { defineComponent, toRef, computed, useSSRContext, withCtx, createVNode, renderSlot, mergeProps, openBlock, createBlock, createCommentVNode, createTextVNode, toDisplayString } from 'vue';
import { twMerge, twJoin } from 'tailwind-merge';
import { u as useUI } from './selectMenu-YFOg1enb.mjs';
import { m as mergeConfig, a as appConfig, e as useRoute, _ as _export_sfc } from '../server.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      const _component_BaseLayoutDefaultPage = _sfc_main$4;
      ...
      _push(ssrRenderComponent(_component_BaseLayoutDefaultPage, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(ssrRenderComponent(_component_PageContainer, { class: "flex gap-6" }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div class="w-2/12 flex flex-col"${_scopeId2}>`);
            ...
            return [
              createVNode("div", { class: "flex-1" }, [
                createVNode(_component_PageContainer, { class: "flex gap-6" }, {
                  default: withCtx(() => [
                    createVNode("div", { class: "w-2/12 flex flex-col" }, [
                      createVNode(_component_UVerticalNavigation, { links })
                    ]),
...
//# sourceMappingURL=dashboard-18xbXtc1.mjs.map
