import { _ as __nuxt_component_0 } from './nuxt-link-l5vQ35gn.mjs';
import { _ as __nuxt_component_2, c as getNuxtLinkProps } from './Button-kAcpi0J0.mjs';
...
import { u as useUI, a as arrow } from './selectMenu-YFOg1enb.mjs';
...
import { y, w as w$1, h, o as o$1, i as c$2, u as u$2, l, H as H$1, t as t$1, b, p as p$1, j as p$2, N as N$1, k as p, n as u, q as usePopper, x, r as a$2, c as o$2, v, g as N, _, O as O$1 } from './usePopper-Q71pE1n8.mjs';
...
let Me = defineComponent({ name: "Menu", props: { as: { type: [Object, String], default: "template" } }, setup(r, { slots: b2, attrs: l$1 }) {
  ...
  let p2 = { menuState: I, buttonRef: e, itemsRef: f, items: s, searchQuery: g, activeItemIndex: d, activationTrigger: o$12, closeMenu: () => {
    ...
    let n = t2(), v2 = x(a$1 === a$2.Specific ? { focus: a$2.Specific, id: i } : { focus: a$1 }, { resolveItems: () => n.items, resolveActiveIndex: () => n.activeItemIndex, resolveId: (M) => M.id, resolveDisabled: (M) => M.dataRef.disabled });
...
} }), Re = defineComponent({ name: "MenuButton", props: { disabled: { type: Boolean, default: false }, as: { type: [Object, String], default: "button" }, id: { type: String, default: () => `headlessui-menu-button-${t$1()}` } }, setup(r, { attrs: b$1, slots: l2, expose: I }) {
  let e = O("MenuButton");
    ...
    switch (o$2$1.key) {
      ...
      case o$2.ArrowDown:
        o$2$1.preventDefault(), o$2$1.stopPropagation(), e.openMenu(), nextTick(() => {
          var t2;
          (t2 = o$1(e.itemsRef)) == null || t2.focus({ preventScroll: true }), e.goToItem(a$2.First);
        });
        break;
      case o$2.ArrowUp:
        o$2$1.preventDefault(), o$2$1.stopPropagation(), e.openMenu(), nextTick(() => {
          var t2;
          (t2 = o$1(e.itemsRef)) == null || t2.focus({ preventScroll: true }), e.goToItem(a$2.Last);
        });
        break;
    }
  }
...
} }), he = defineComponent({ name: "MenuItems", props: { as: { type: [Object, String], default: "div" }, static: { type: Boolean, default: false }, unmount: { type: Boolean, default: true }, id: { type: String, default: () => `headlessui-menu-items-${t$1()}` } }, setup(r, { attrs: b2, slots: l$1, expose: I }) {
  ...
  function s(t2) {
    ...
    switch (f.value && clearTimeout(f.value), t2.key) {
      ...
      case o$2.Enter:
        ...
        break;
      case o$2.ArrowDown:
        return t2.preventDefault(), t2.stopPropagation(), e.goToItem(a$2.Next);
      case o$2.ArrowUp:
        return t2.preventDefault(), t2.stopPropagation(), e.goToItem(a$2.Previous);
      case o$2.Home:
      case o$2.PageUp:
        return t2.preventDefault(), t2.stopPropagation(), e.goToItem(a$2.First);
      case o$2.End:
      case o$2.PageDown:
        return t2.preventDefault(), t2.stopPropagation(), e.goToItem(a$2.Last);
      case o$2.Escape:
...
} }), ye = defineComponent({ name: "MenuItem", inheritAttrs: false, props: { as: { type: [Object, String], default: "template" }, disabled: { type: Boolean, default: false }, id: { type: String, default: () => `headlessui-menu-item-${t$1()}` } }, setup(r, { slots: b2, attrs: l2, expose: I }) {
  ...
  function t2() {
    if (r.disabled)
      return e.goToItem(a$2.Nothing);
    e.goToItem(a$2.Specific, r.id);
  }
  let p2 = u();
  function a$1(n) {
    p2.update(n);
  ...
  function i(n) {
    p2.wasMoved(n) && (r.disabled || s.value || e.goToItem(a$2.Specific, r.id, 0));
  }
  function u2(n) {
    p2.wasMoved(n) && (r.disabled || s.value && e.goToItem(a$2.Nothing));
  }
  return () => {
    let { disabled: n } = r, v2 = { active: s.value, disabled: n, close: e.closeMenu }, { id: M, ...x2 } = r;
    return H$1({ ourProps: { id: M, ref: f, role: "menuitem", tabIndex: n === true ? void 0 : -1, "aria-disabled": n === true ? true : void 0, disabled: void 0, onClick: o$12, onFocus: t2, onPointerenter: a$1, onMouseenter: a$1, onPointermove: i, onMousemove: i, onPointerleave: u2, onMouseleave: u2 }, theirProps: { ...l2, ...x2 }, slot: v2, attrs: l2, slots: b2, name: "MenuItem" });
  };
} });
...
//# sourceMappingURL=Dropdown-7SK4kIQ5.mjs.map
