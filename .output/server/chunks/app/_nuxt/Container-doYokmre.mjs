import { defineComponent, toRef, computed, useSSRContext, withCtx, renderSlot, createVNode, resolveDynamicComponent, mergeProps } from 'vue';
import { twMerge, twJoin } from 'tailwind-merge';
import { u as useUI } from './selectMenu-b22BRv44.mjs';
import { m as mergeConfig, a as appConfig } from '../server.mjs';
import { ssrRenderComponent, ssrRenderSlot, ssrRenderVNode } from 'vue/server-renderer';
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/Page/Container.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const __nuxt_component_1 = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender]]);

export { __nuxt_component_1 as _ };
//# sourceMappingURL=Container-doYokmre.mjs.map
