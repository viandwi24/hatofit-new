import { _ as __nuxt_component_2, u as useInjectButtonGroup } from './Button-kAcpi0J0.mjs';
import { _ as __nuxt_component_1 } from './Avatar-tswZooNR.mjs';
...
import { s as select, b as selectMenu, u as useUI, g as get } from './selectMenu-YFOg1enb.mjs';
import { u as u$2, x, r as a$2, o as o$1$1, y, i as c$2, l, f as f$1, K, a as a$1, H as H$1, T as T$1, t as t$1, b, m, N as N$1, j as p$2, p as p$1, n as u, w as w$1, h as h$1, k as p, q as usePopper, O, c as o$2, e as t$2 } from './usePopper-Q71pE1n8.mjs';
...
let Je = defineComponent({ name: "Combobox", emits: { "update:modelValue": (l2) => true }, props: { as: { type: [Object, String], default: "template" }, disabled: { type: [Boolean], default: false }, by: { type: [String, Function], default: () => Oe }, modelValue: { type: [Object, String, Number, Boolean], default: void 0 }, defaultValue: { type: [Object, String, Number, Boolean], default: void 0 }, form: { type: String, optional: true }, name: { type: String, optional: true }, nullable: { type: Boolean, default: false }, multiple: { type: [Boolean], default: false } }, inheritAttrs: false, setup(l$1, { slots: y$1, attrs: r, emit: w2 }) {
  ...
  let k = computed(() => l$1.multiple ? 1 : 0), m2 = computed(() => l$1.nullable), [o2, h$12] = d(computed(() => l$1.modelValue), (n2) => w2("update:modelValue", n2), computed(() => l$1.defaultValue)), C = computed(() => o2.value === void 0 ? u$2(k.value, { [1]: [], [0]: void 0 }) : o2.value), E = null, R = null, i2 = { comboboxState: e$1, value: C, mode: k, compare(n2, u2) {
    ...
    P.value = false, E !== null && cancelAnimationFrame(E), E = requestAnimationFrame(() => {
      ...
      let f2 = x(n2 === a$2.Specific ? { focus: a$2.Specific, id: u2 } : { focus: n2 }, { resolveItems: () => a$12.options, resolveActiveIndex: () => a$12.activeOptionIndex, resolveId: (T2) => T2.id, resolveDisabled: (T2) => T2.dataRef.disabled });
    ...
    } })), i2.goToOption(a$2.Specific, u$12);
...
let Ge = defineComponent({ name: "ComboboxButton", props: { as: { type: [Object, String], default: "button" }, id: { type: String, default: () => `headlessui-combobox-button-${t$1()}` } }, setup(l2, { attrs: y2, slots: r, expose: w2 }) {
  ...
  function d2() {
    ...
    o2 && (o2.scrollTop = 0), t2.goToOption(a$2.Nothing);
  }
  let b2 = computed(() => {
    var h2;
  ...
  function P(o2) {
    switch (p2.value = true, o2.key) {
      case o$2.Enter:
        ...
        break;
      case o$2.ArrowDown:
        return p2.value = false, o2.preventDefault(), o2.stopPropagation(), u$2(t2.comboboxState.value, { [0]: () => t2.goToOption(a$2.Next), [1]: () => t2.openCombobox() });
      case o$2.ArrowUp:
        return p2.value = false, o2.preventDefault(), o2.stopPropagation(), u$2(t2.comboboxState.value, { [0]: () => t2.goToOption(a$2.Previous), [1]: () => {
          t2.openCombobox(), nextTick(() => {
            t2.value.value || t2.goToOption(a$2.Last);
          });
        } });
      case o$2.Home:
        if (o2.shiftKey)
          break;
        return p2.value = false, o2.preventDefault(), o2.stopPropagation(), t2.goToOption(a$2.First);
      case o$2.PageUp:
        return p2.value = false, o2.preventDefault(), o2.stopPropagation(), t2.goToOption(a$2.First);
      case o$2.End:
        if (o2.shiftKey)
          break;
        return p2.value = false, o2.preventDefault(), o2.stopPropagation(), t2.goToOption(a$2.Last);
      case o$2.PageDown:
        return p2.value = false, o2.preventDefault(), o2.stopPropagation(), t2.goToOption(a$2.Last);
      case o$2.Escape:
  ...
  function j(m2) {
    I.wasMoved(m2) && (l2.disabled || p2.value || e2.goToOption(a$2.Specific, t2, 0));
  }
  function k(m2) {
    I.wasMoved(m2) && (l2.disabled || p2.value && (e2.optionsPropsRef.value.hold || e2.goToOption(a$2.Nothing)));
  }
  return () => {
...
let Be = defineComponent({ name: "Listbox", emits: { "update:modelValue": (t2) => true }, props: { as: { type: [Object, String], default: "template" }, disabled: { type: [Boolean], default: false }, by: { type: [String, Function], default: () => pe }, horizontal: { type: [Boolean], default: false }, modelValue: { type: [Object, String, Number, Boolean], default: void 0 }, defaultValue: { type: [Object, String, Number, Boolean], default: void 0 }, form: { type: String, optional: true }, name: { type: String, optional: true }, multiple: { type: [Boolean], default: false } }, inheritAttrs: false, setup(t2, { slots: v, attrs: l$1, emit: L }) {
  ...
  let y$1 = computed(() => t2.multiple ? 1 : 0), [h$2, M] = d(computed(() => t2.modelValue), (a2) => L("update:modelValue", a2), computed(() => t2.defaultValue)), w$1$1 = computed(() => h$2.value === void 0 ? u$2(y$1.value, { [1]: [], [0]: void 0 }) : h$2.value), r = { listboxState: e$1, value: w$1$1, mode: y$1, compare(a2, n2) {
    ...
    if (t2.disabled || e$1.value === 1)
      return;
    let s = k(), O2 = x(a$12 === a$2.Specific ? { focus: a$2.Specific, id: n2 } : { focus: a$12 }, { resolveItems: () => s.options, resolveActiveIndex: () => s.activeOptionIndex, resolveId: (P) => P.id, resolveDisabled: (P) => P.dataRef.disabled });
  ...
  return onMounted(() => {
    ...
    return h(Fragment, [...a2 != null && w$1$1.value != null ? e({ [a2]: w$1$1.value }).map(([I, Q]) => h(f$1, K({ features: a$1.Hidden, key: I, as: "input", type: "hidden", hidden: true, readOnly: true, form: s, name: I, value: Q }))) : [], H$1({ ourProps: {}, theirProps: { ...l$1, ...T$1(O2, ["defaultValue", "onUpdate:modelValue", "horizontal", "multiple", "by"]) }, slot: P, slots: v, attrs: l$1, name: "Listbox" })]);
  };
} });
...
let Ne = defineComponent({ name: "ListboxButton", props: { as: { type: [Object, String], default: "button" }, id: { type: String, default: () => `headlessui-listbox-button-${t$1()}` } }, setup(t2, { attrs: v, slots: l2, expose: L }) {
    ...
    switch (o2.key) {
      ...
      case o$2.ArrowDown:
        o2.preventDefault(), e2.openListbox(), nextTick(() => {
          var i2;
          (i2 = o$1$1(e2.optionsRef)) == null || i2.focus({ preventScroll: true }), e2.value.value || e2.goToOption(a$2.First);
        });
        break;
      case o$2.ArrowUp:
        o2.preventDefault(), e2.openListbox(), nextTick(() => {
          var i2;
          (i2 = o$1$1(e2.optionsRef)) == null || i2.focus({ preventScroll: true }), e2.value.value || e2.goToOption(a$2.Last);
        });
        break;
    }
  }
  ...
  function b2(o2) {
    switch (d2.value && clearTimeout(d2.value), o2.key) {
      ...
      case u$2(e2.orientation.value, { vertical: o$2.ArrowDown, horizontal: o$2.ArrowRight }):
        return o2.preventDefault(), o2.stopPropagation(), e2.goToOption(a$2.Next);
      case u$2(e2.orientation.value, { vertical: o$2.ArrowUp, horizontal: o$2.ArrowLeft }):
        return o2.preventDefault(), o2.stopPropagation(), e2.goToOption(a$2.Previous);
      case o$2.Home:
      case o$2.PageUp:
        return o2.preventDefault(), o2.stopPropagation(), e2.goToOption(a$2.First);
      case o$2.End:
      case o$2.PageDown:
        return o2.preventDefault(), o2.stopPropagation(), e2.goToOption(a$2.Last);
      case o$2.Escape:
  ...
  function M(r) {
    y2.wasMoved(r) && (t2.disabled || b2.value || e2.goToOption(a$2.Specific, t2.id, 0));
  }
  function w2(r) {
    y2.wasMoved(r) && (t2.disabled || b2.value && e2.goToOption(a$2.Nothing));
  }
  return () => {
...
//# sourceMappingURL=SelectMenu-EZqWnZTs.mjs.map
