import { _ as __nuxt_component_1 } from './Container-fiqteY-J.mjs';
...
import { _ as __nuxt_component_1$1 } from './Avatar-tswZooNR.mjs';
import { _ as __nuxt_component_6 } from './ButtonColorMode-OZnQ_7Ik.mjs';
import { b as useSeoMeta, d as useAuth, h as __nuxt_component_7 } from '../server.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_PageContainer, { class: "flex-1 flex justify-between w-full items-center" }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
...
//# sourceMappingURL=DefaultPage-LzR7S962.mjs.map
